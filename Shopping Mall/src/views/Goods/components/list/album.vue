<template>
  <div>
    <el-dialog :title="`${item.name} -相册`" :visible.sync="isDialog" :close-on-click-modal="false" @close="close" width="60%" :center="true">
      <el-row :gutter="20">
        <el-col :span="4" v-for="item in form" :key="item.thumb">
          <div style="position:relative">
            <img class="imgPic" :src="item.thumb">
